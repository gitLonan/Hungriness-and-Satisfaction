...
MARKO = {'broad': {'meat': 0.3, 'vegetable': 0.2, 'sweet':0.1},
        'specific': {'sesam':0.1,'eggs':0.2,'french fries':0.2,'kajmak':-0.2,'sandwich':0.2,
                    ...
                    'chicken':0.2,'schnitzel':0.3,'sausage':0.6,'kebab':0.2,'bacon':0.3,
...
#tags Teodora
TEODORA = {'broad': {'meat':0.1 , 'vegetable':0.6, 'sweet':0},
        'specific': {'sesam':0.2,'eggs':0.4,'french fries':0.5,'kajmak':0,'sandwich':0.2,
...
VELJKO = {'broad': {'meat': 0.35, 'vegetable': 0.25, 'sweet':0.2},
        'specific': {'sesam':0.1,'eggs':-0.1,'french fries':0.2,'kajmak':0.1,'sandwich':0.2,
                    'tortilla':0.6,'bun':0.1,'flatbread':0.2,
...
ANA = {'broad': {'meat': 0.2, 'vegetable': 0.3, 'sweet': -0.2},
        'specific': {'sesam':0.6,'eggs':0.1,'french fries':0.1,'kajmak':0.1,'sandwich':0.2,
